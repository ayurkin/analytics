...
type AuthApiClient interface {
	...
	UpdateTokens(ctx context.Context, in *UserCredits, opts ...grpc.CallOption) (*TokenCredits, error)
}
...
func (c *authApiClient) UpdateTokens(ctx context.Context, in *UserCredits, opts ...grpc.CallOption) (*TokenCredits, error) {
	out := new(TokenCredits)
...
type AuthApiServer interface {
	...
	UpdateTokens(context.Context, *UserCredits) (*TokenCredits, error)
...
func (UnimplementedAuthApiServer) UpdateTokens(context.Context, *UserCredits) (*TokenCredits, error) {
...
func _AuthApi_UpdateTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthApiServer).UpdateTokens(ctx, req.(*UserCredits))
	}
	return interceptor(ctx, in, info, handler)
}
